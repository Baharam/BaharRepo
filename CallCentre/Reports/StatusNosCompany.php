...
function LoadData()
{
	...
	$result = sqlsrv_query( $conn, "select * from StatusNosCompany order by [Company], [Status]");
...
function ImprovedTable($header, $data)
{
	...
	if ($lastrow != $currentrow){
		if ($lastrow != ''){
	  	...
	  	$this->Cell(15,6,'','LRTB', 0, 'C');
	  	$this->Cell(80,6,'Total','LRTB', 0, 'R');
...
// Column headings
$header = array('Company', 'Status', 'Description', 'Total');

$pdf->SetFont('Times','',12);
$pdf->ImprovedTable($header,$data);
        
$pdf->Cell(40,6,'','LRTB', 0, 'C');
$pdf->Cell(15,6,'','LRTB', 0, 'C');
$pdf->Cell(80,6,'Grand Total','LRTB', 0, 'R');
